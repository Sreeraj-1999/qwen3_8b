...
MARITIME_ZONES = [
    ...
    ("Persian Gulf", [
        [30.0, 48.0], [29.9, 49.5], [28.5, 50.5], [27.0, 51.5],
        [26.0, 52.0], [25.0, 52.5], [24.0, 53.5], [23.5, 55.0],
    ...
    ("Baltic Sea", [
        [53.5, 9.5], [54.5, 12.0], [55.0, 13.5], [55.5, 15.0],
        [56.5, 16.5], [57.5, 18.0], [58.5, 19.0], [60.0, 20.0],
        [61.0, 21.0], [63.0, 19.5], [64.0, 21.0], [65.0, 25.5],
        [66.0, 26.0], [66.0, 23.0], [65.0, 21.0], [64.0, 18.0],
        [63.0, 17.0], [61.0, 17.0], [59.0, 16.5], [57.0, 13.0],
        [55.5, 10.5], [54.0, 9.5],
    ]),
    ...
    ("Sea of Japan", [
        [34.0, 128.0], [35.5, 129.5], [37.0, 130.0], [39.0, 131.0],
        [41.0, 131.5], [43.0, 133.0], [46.0, 138.0], [48.0, 140.5],
        [52.0, 141.5], [51.0, 143.0], [46.0, 142.0], [43.0, 140.0],
        [40.0, 139.5], [37.0, 137.0], [35.0, 133.0], [34.0, 131.0],
    ]),
    ...
    ("Bab el-Mandeb Strait", [
        [12.0, 43.0], [12.8, 43.0], [13.0, 43.5], [12.5, 44.5],
        [11.5, 44.0],
    ]),
    ...
    ("Gulf of Aden", [
        [11.0, 43.0], [11.5, 44.0], [12.0, 45.0], [12.5, 47.0],
        [13.0, 49.0], [14.0, 51.0], [15.0, 52.0], [14.5, 53.0],
        [12.0, 52.0], [11.0, 49.0], [10.5, 46.0], [10.5, 44.0],
    ]),
    ...
    ("Indian Ocean", [
        [-55.0, 20.0], [-55.0, 120.0], [-10.0, 120.0], [0.0, 100.0],
        [5.0, 80.0], [10.0, 75.0], [15.0, 73.0], [22.0, 60.0],
        [25.0, 57.0], [30.0, 32.0], [20.0, 38.0], [12.0, 43.0],
        [5.0, 42.0], [0.0, 42.0], [-10.0, 40.0], [-20.0, 35.0],
        [-30.0, 25.0], [-40.0, 20.0],
    ]),
